...
class LogansRoomLight(LightEntity):
    """LogansRoom Light."""
    ...
    def __init__(self) -> None:
        ...
        self._strip = strip_entity
        self._name = "LogansRoom"
        # self._state = 'off'
        self._brightness = 0
    ...
    def should_poll(self):
        """Allow for color changes to be polled"""
        return True
    ...
    async def json_switch_message_received(
        ...
        button_map_data = json.load(
            open("custom_components/logans_room_light/button_map.json")
        )
